...
|Seq# |Project Name|Description|Status|AWS CloudFormation|AWS SAM|Serverless|HashiCorp Terraform|
|---|---|---|---|---|---|---|---|
|1||Manage a Batch Job (AWS Batch, Amazon SNS)|||
|2||Manage a Container Task (Amazon ECS, Amazon SNS)
|3|Celosia|Transfer Data Records (Lambda, DynamoDB, Amazon SQS)|Done|[:heavy_check_mark: Done](https://github.com/subhamay-cloudworks/0069-celosia-cft)|[:heavy_check_mark: Done](https://github.com/subhamay-cloudworks/0069-celosia-sam)|[:heavy_check_mark: Done](https://github.com/subhamay-cloudworks/0069-celosia-sls)|[:heavy_check_mark: Done](https://github.com/subhamay-cloudworks/0069-celosia-tf)|
|4||Poll for Job Status (Lambda, AWS Batch)
...
|9||Dynamically process data with a Map state
