...
|2|0032|Allium|Creating a S3 Bucket with Lifecycle Policy Configuration using Terraform.|:x:|:x:|:x:|:x:|[:white_check_mark:](https://github.com/subhamay-cloudworks/0032-allium-tf)|
|3|0088|Decumaria|Enable CloudTrain Trail for DynamoDB data events.|:x:|:x:|:x:|:x:|:x:|
|4|0089|Delphinium|Scheduling a Lambda function using EventBridge to send an email every day using SES and a pre-signed URL of an image .|:x:|:x:|:x:|:x:|[:white_check_mark:](https://github.com/subhamay-cloudworks/0089-delphinium-tf)|
