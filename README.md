...
|3|0089|Delphinium|Scheduling a Lambda function using EventBridge to send an email every day using SES and a pre-signed URL of an image .|:x:|:x:|:x:|:x:|[:white_check_mark:](https://github.com/subhamay-cloudworks/0089-delphinium-tf)|
